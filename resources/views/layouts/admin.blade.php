        ...
        <div class="container-fluid header_part">
            <div class="row">
                ...
                <div class="col-md-3 top_right_menu text-end">
                    <div class="dropdown">
                      <button class="btn dropdown-toggle top_right_btn text-capitalize" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="col-md-2 sidebar_part">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="{{url('dashboard/user')}}"><i class="fas fa-images"></i> Income</a></li>
                            <li><a href="{{url('dashboard/user')}}"><i class="fas fa-comments"></i> Expense</a></li>
                            <li><a href="{{url('dashboard/income/category')}}"><i class="fas fa-globe"></i> Income Category</a></li>
                            <li><a href="{{url('dashboard/user')}}"><i class="fas fa-sign-out-alt"></i> Expense Category</a></li>
                            <li><a href="{{url('dashboard/user')}}"><i class="fas fa-sign-out-alt"></i> Reports</a></li>
                            <li><a href="{{url('dashboard/user')}}"><i class="fas fa-sign-out-alt"></i> Recycle Bin</a></li>
        ...
        <div class="container-fluid footer_part">
            <div class="row">
                ...
                <div class="col-md-10 copyright">
                    <p>Copyright &copy; 2023 | All rights reserved by Onirban Bangladesh Technologies | Development By <a href="#">Marwa Khanom Nurtaj.</a></p>
                </div>
                <div class="clr"></div>
            </div>
        </div>
