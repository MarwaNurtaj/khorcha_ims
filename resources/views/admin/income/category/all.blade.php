                  ...
                  <td>
                      <div class="btn-group btn_group_manage" role="group">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{url('dashboard/income/category/view/'.$data->incate_id)}}">View</a></li>
                          <li><a class="dropdown-item" href="{{url('dashboard/income/category/edit/'.$data->incate_slug)}}">Edit</a></li>
                          <li><a class="dropdown-item" href="{{url('dashboard/income/category/softdelete/'.$data->incate_slug)}}">Delete</a></li>
                        </ul>
                      </div>
                  </td>
                </tr>
